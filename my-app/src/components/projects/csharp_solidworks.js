...
class csharp_solidworks extends Component {
        render() {
            return(
                <div className="tab-content" style={{paddingBottom:'1em'}}>
                <h2>Leapfrogging technical debt</h2>
                    ...
                    <ul>
                        ...
                        <ul>
                            <li>Creating my own (better if I do say so myself) fastener toolbox system/database as the native SolidWorks one was a buggy mess.</li>
                            <li>Checks when saving and exporting new parts, to ensure key property fields are populated and correct.</li>
                            <li>Moving the key property fields into a drop down select options instead; ensuring consistency in spelling and notation across designers.</li>
                            <li>Automatic sorting of exported files into the appropriate production server folder.</li>
                            <li>Automatic PDF manual export (recursively going through an assembly's constituent parts and exporting all assembly and manufacturing drawings).</li>
                        </ul>
                        ...
                        <ul>
                            <li>Automatically sorting parts into sheets based on type (if the tool detects weldment features in a part, it would sort it into weldment table, likewise for sheet metal parts etc.).</li>
                            <li>Automatically applying checks for critical properties depending on the part type. For example, if a sheet metal part has a thickness of 5mm, it will flag any bend features with the incorrect radii for this thickness.</li>
                            <li>Really pretty color coding and formatting in Excel (for highlighting if any of the above is missed). I can't stress enough how hard it was to present the BOM in an aesthetically pleasing and dynamically resizing spreadsheet.</li>
                        </ul>
                    </ul>
                </div>
            )
